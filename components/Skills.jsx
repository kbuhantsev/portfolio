...
const Skills = () => {
  return (
    <>
      <h2 className="font-bold text-8xl mt-24 w-full text-center mb-32 md:text-6xl xs:text-4xl md:mb-16 ">
        Skills
      </h2>
      <div
        className="w-[60vw] 
       h-screen relative flex items-center
       justify-center rounded-full bg-circularLight dark:bg-circularDark 
       xs:h-[30vh] sm:h-[60vh] md:h-[60vh] lg:h-[80vh] xl:h-[80vh] 
